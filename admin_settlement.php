...
<body class="bg-slate-100 min-h-screen p-6 md:p-12">
    <div class="max-w-[96rem] mx-auto space-y-8">
        <header class="flex justify-between items-end">
            <div>
                <h1 class="text-4xl font-black italic text-slate-900 uppercase tracking-tighter">Settlement</h1>
                <p class="text-slate-500 text-xs font-bold mt-2 uppercase">가맹점 정산 요청 지급 처리</p>
            </div>

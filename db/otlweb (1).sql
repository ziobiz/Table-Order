...
CREATE TABLE `categories` (
  `id` int(11) NOT NULL,
  `menu_format_id` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `categories` (`id`, `menu_format_id`, `store_id`, `category_name`, `sort_order`) VALUES
(1, 1, 1, '메인 메뉴', 1),
(2, 1, 1, '음료', 0),
(3, 1, 1, '디저트', 0),
(4, 1, 1, '후식', 0);
...
INSERT INTO `menus` (`id`, `menu_format_id`, `store_id`, `category_id`, `is_available`, `is_dinein`, `is_pickup`, `is_delivery`, `price`, `price_pickup`, `price_delivery`, `daily_limit`, `current_stock`, `image_url`) VALUES
(1, 1, 1, 1, 1, 1, 1, 1, 10000, 9000, 12000, 0, 46, NULL);
...
--
-- 테이블의 덤프 데이터 `menu_formats`
--

INSERT INTO `menu_formats` (`id`, `name`, `description`, `sort_order`, `is_active`, `created_at`) VALUES
(1, '기본', '기본 메뉴 포맷 (마이그레이션용)', 0, 1, '2026-02-20 01:15:39');
...
INSERT INTO `option_groups` (`id`, `menu_format_id`, `store_id`, `group_name_ko`, `is_required`, `max_select`) VALUES
(1, 1, 1, '추가 토핑', 0, 3),
(2, 1, 1, '사이즈 선택', 1, 1);
...
(32, NULL, 1, 'dinein', 15000, '', '', '', '2026-02-19 21:38:48', '2026-02-19 23:06:00', 0, 15000, '', ''),
(33, NULL, 1, 'dinein', 18000, '', '', '', '2026-02-19 23:14:45', '2026-02-19 23:27:20', 0, 18000, 'Table 5', ''),
(34, NULL, 1, 'dinein', 16000, '', '', 'pending', '2026-02-19 23:50:34', '2026-02-19 23:50:34', 0, 16000, 'Table 5', '');
...
(40, 32, 1, 1, 15000, '치즈 추가, 계란 후라이, 곱빼기 고기', 'served'),
(41, 33, 1, 1, 18000, '치즈 추가 x3, 계란 후라이 x2, 곱빼기 고기', 'served'),
(42, 34, 1, 1, 16000, '치즈 추가 x2, 계란 후라이, 곱빼기 고기', 'served');
...
CREATE TABLE `stores` (
  `id` int(11) NOT NULL,
  `menu_format_id` int(11) NOT NULL DEFAULT '1' COMMENT '본사가 제공한 메뉴 솔루션(포맷) ID',
...
INSERT INTO `stores` (`id`, `menu_format_id`, `store_name`, `currency_code`, `service_charge_type`, `service_charge_rate`, `tax_inclusive`, `tax_rate`, `allow_tip`, `tip_type`, `tip_value`, `point_policy`, `point_rate`, `point_payer`, `point_policy_id`, `username`, `password`, `kds_theme`, `kds_alert_5`, `kds_alert_10`, `kds_alert_20`, `kds_alert_30`, `kds_sound`, `kds_sound_custom`, `use_local_status`, `kds_datetime_locale`, `kds_sync_order_status`, `kds_kitchen_theme`) VALUES
(1, 1, 'Demo Store', 'KRW', 'NONE', 0, 'N', 10, 'N', 'PERCENT', 0, 'NONE', 0, 'STORE', 1, 'store1', 'store1234', 'pastel', 5, 10, 15, 20, 'chime1', '', 0, 'ko', 1, 'sky');

-- --------------------------------------------------------

--
-- 테이블 구조 `store_menu_overrides`
--
...
--
-- 테이블의 덤프 데이터 `store_tables`
--

INSERT INTO `store_tables` (`id`, `store_id`, `table_no`, `created_at`) VALUES
(1, 1, 1, '2026-02-19 22:18:16'),
(2, 1, 2, '2026-02-19 22:18:16'),
(3, 1, 3, '2026-02-19 22:18:16'),
(4, 1, 4, '2026-02-19 22:18:16'),
(5, 1, 5, '2026-02-19 22:18:16'),
(6, 1, 6, '2026-02-19 22:18:16'),
(7, 1, 7, '2026-02-19 22:18:16'),
(8, 1, 8, '2026-02-19 22:18:16'),
(9, 1, 9, '2026-02-19 22:18:16'),
(10, 1, 10, '2026-02-19 22:18:16');
...
--
-- 테이블의 인덱스 `menu_formats`
--
ALTER TABLE `menu_formats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_menu_formats_active` (`is_active`);
...
ALTER TABLE `option_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_option_groups_store` (`store_id`);
...
--
-- 테이블의 인덱스 `store_menu_overrides`
--
ALTER TABLE `store_menu_overrides`
  ADD PRIMARY KEY (`store_id`,`menu_id`),
  ADD KEY `idx_store_menu_overrides_store` (`store_id`),
  ADD KEY `idx_store_menu_overrides_menu` (`menu_id`);

--
-- 테이블의 인덱스 `store_tables`
--
ALTER TABLE `store_tables`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_store_table` (`store_id`,`table_no`),
...
--
-- 테이블의 AUTO_INCREMENT `menu_formats`
--
ALTER TABLE `menu_formats`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- 테이블의 AUTO_INCREMENT `store_tables`
--
ALTER TABLE `store_tables`
